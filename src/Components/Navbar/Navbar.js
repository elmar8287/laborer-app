...
//         <Link to="/tickets" className="nav-link">My requests ({myTickets.filter(e => e.user===user.email).length}) </Link>
//         <Link to="/account" className="nav-link">Account</Link>
//         {/* <Link to="/about" className="nav-link">About & Help</Link> */}
//         <Link to="/">
//           <button type="button" onClick={handleLogout} className='text-gray-200'>Log out</button>
//         </Link>
